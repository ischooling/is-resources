					...
					+'<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">'
						+'<div class="d-flex align-items-end flex-wrap ">'
							+'<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-12">'
								+'<span class="h4 bold mt-3 mr-4 pl-sm-0 reportTitle"></span>'
								...
								+'</select>'
							+'</div>'
							+'<div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3">'
								+'<label>Start Date</label>'
								+'<input class="form-control" type="text" id="startDate" autocomplete="off" disabled/>'
							+'</div>'
							+'<div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3">'
								+'<label>End Date</label>'
								+'<input class="form-control" type="text" id="endDate" autocomplete="off" disabled/>'
							+'</div>'
							...
							+'<div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3">'
								...
								+'</select>'
							+'</div>'
							+'<div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3" style="display:none;">'
								+'<label>Teacher ID</label>'
								+'<input type="hidden" name="teacherId" id="teacherId" class="form-control" value="" maxlength="100"/>'
							+'</div>'
							+'<div class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-xs-12 mt-3" style="display:block;">'
							...
							+'</div>'
							+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-5 col-xs-12 mt-3">'
								+'<button class="btn btn-sm btn-primary" onclick="studentAssginedReportSearch(\'studentAssignedReportFilter\',\''+roleAndModule.moduleId+'\','+userId+',\''+role+'\');"><i class="fa fa-check"></i>&nbsp;Apply</button>'
								+'<button class="btn btn-sm btn-primary" onclick="studentAssginedReportSearchReset(\'studentAssignedReportFilter\')"><i class="fa fa-check"></i>&nbsp;Reset</button>'
							+'</div>'
						+'</div>'
					+'</div>'
				+'</div>'
					...
					+'<table class=\"table row-height-small table-bordered  text-center\">'
						+'<thead>'
							+'<tr class=\"bg-dark-gray\">'
								...
								+'<th class=\"text-white\"><b>Teacher Name</b></th>'
								+'<th class=\"text-white\"><b>Location</b></th>'
								+'<th class=\"text-white\"><b>Employee Status</b></th>'
								+'<th class=\"text-white\"><b>Working Hours/Agreed</b></th>'
								+'<th class=\"text-white\"><b>Total Student</b></th>'
							+'</tr>'
						+'</thead>'
