						...
						+'<div class="row px-3">';
							...
							if(role!='TEACHER'){
								html+='<div class="col-md-3 col-sm-3 col-xs-12">'
										...
										+'<select name="sessionId" id="sessionId" multiple class="form-control"></select>'
									+'</div>';
							}
							...
							html+='<div class="col-md-3 col-sm-6 col-12 mb-2">'
										...
										+'<select name="standardId" id="standardId" class="form-control">'
											...
											+getStandardContent(schoolId,true)
										+'</select>'
									+'</div>';
							if(role!='TEACHER'){
								html+='<div class="col-md-3 col-sm-3 col-12 mb-2">'
							...
							if(role!='TEACHER'){
								...
								+'<div class="col-md-3 col-sm-6 col-xs-12">'
									...
									+'<input type="text" name="applicationNo" id="applicationNo" class="form-control" value="" maxlength="100"/>'
								+'</div>'
								+'<div class="col-md-3 col-sm-6 col-12 mb-2">'
							...
							// 	+'</select>'
							// +'</div>'
							+'<div class="col-md-3 col-sm-3 col-12 mb-2" style="display:'+(role=='TEACHER'?'none':'block')+';">'
							...
							+'<div class="col-md-12 col-sm-12 col-12 text-right">'
								+'<button class="btn btn-sm btn-success" onclick="advanceClassroomSearch(\'classroomSessionFilter\',\''+roleAndModule.moduleId+'\','+userId+',\''+role+'\');"><i class="fa fa-check"></i>&nbsp;Search</button>'
								+'<button class="btn btn-sm btn-primary mr-1" onclick="advanceClassroomSearchReset(\'classroomSessionFilter\')"><i class="fa fa-check"></i>&nbsp;Reset</button>'
							+'</div>'
						+'</div>'
					+'</div>'
				+'</form>'
