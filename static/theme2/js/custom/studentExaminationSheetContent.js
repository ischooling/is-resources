    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <div class="full hide-tab">
                ${hasFile ? `<iframe src="${getPdfViewerUrl(filePath)}" type="application/pdf" width="100%" height="500" style="overflow:auto;"></iframe>` : `<h4 class="text-center">Your Examination Schedule is going to upload soon.</h4>`}
            </div>
        </div>
    </div>`;
}
