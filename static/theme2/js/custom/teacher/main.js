...
function setSteps(step){
    ...
    if ( step === 1) {
        ...
        $("#step2_li, #step3_li, #step4_li, #step5_li, #step6_li").removeClass('completed current');
    } else {
        $('.steps ul li:first-child a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(0,true)}</span>`);
        ...
        $('.steps ul li:nth-child(6) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(5,false)}</span>`);
        $('.actions > ul > li:first-child').attr('style', 'opacity:0');
        $(".step1, .step2, .step3, .step4, .step5").removeClass("done-step-teacher");
        $("#step1_li").addClass("current");
        $("#step2_li, #step3_li, #step4_li, #step5_li, #step6_li").removeClass('completed current');
    ...
    if (step === 2) {
        $('.steps ul li:first-child a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        ...
        $("#step1_li, #step3_li, #step4_li, #step5_li, #step6_li").removeClass('completed current');
    ...
    if(step === 3) {
        $('.steps ul li:first-child a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(2) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(3) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(2,true)}</span>`);
        $('.steps ul li:nth-child(4) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(3,false)}</span>`);
        $('.steps ul li:nth-child(5) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(4,false)}</span>`);
        $('.steps ul li:nth-child(6) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(5,false)}</span>`);
        $('.actions > ul > li:first-child').attr('style', 'opacity:1');
        $("#step4_li, #step5_li, #step6_li").removeClass('completed current');
    ...
    if ( step === 4) {
        $('.steps ul li:first-child a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(2) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(3) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(4) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(3,true)}</span>`);
        $('.steps ul li:nth-child(5) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(4,false)}</span>`);
        $('.steps ul li:nth-child(6) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(5,false)}</span>`);
        $('.actions > ul > li:first-child').attr('style', 'opacity:1');
        $("#step5_li, #step6_li").removeClass('completed current');
        $("#step1_li, #step2_li, #step3_li").addClass('completed').removeClass('current');
    ...
    if ( step === 5) {
        ...
        $('.steps ul li:nth-child(2) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(3) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(4) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(5) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(4,true)}</span>`);
        $('.steps ul li:nth-child(6) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(5,false)}</span>`);
        $('.actions > ul > li:first-child').attr('style', 'opacity:1');
        $("#step6_li").removeClass('completed current');
        $("#step1_li, #step2_li, #step3_li, #step4_li").addClass('completed').removeClass('current');
        $("#step5_li").addClass('current');
        // $('.actions > ul > li:first-child').attr('style', 'opacity:0');
    ...
    if ( sectionLength == step) {
        ...
        $('.steps ul li:nth-child(3) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(4) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(5) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(6,true)}</span>`);
        $('.steps ul li:nth-child(6) a .icon-circle').html(`<div class="icon-div"></div><span class="icon">${getIcon(5,true)}</span>`);
        $('.actions > ul > li:first-child').attr('style', 'opacity:1');
        $("#step1_li, #step2_li, #step3_li, #step4_li, #step5_li").addClass('completed').removeClass('current');
        $("#step6_li").addClass('current');
        $('.actions > ul > li:first-child').attr('style', 'opacity:1');
    ...
    if(getSession()){
        ...
        if(moveType == "next"){
            if(nextStep === 1){
                ...
                if(verificationValidationOnSave("teacherSignupStage5")){
...
function createStepsImage(){
    ...
    $('.steps ul li:nth-child(4)').find('a .icon-circle').append(`<div class="icon-div"></div><span class="icon">${getIcon(3,false)}</span>`);
    $('.steps ul li:nth-child(5)').find('a .icon-circle').append(`<div class="icon-div"></div><span class="icon">${getIcon(4,false)}</span>`);
    $('.steps ul li:last-child a .icon-circle').append(`<div class="icon-div"></div><span class="icon">${getIcon(5,false)}</span>`);
}
function getIcon(index, activeFlag){
    var iconArray = 
    [
        `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M10 0C11.3261 0 12.5979 0.526784 13.5355 1.46447C14.4732 2.40215 15 3.67392 15 5C15 6.32608 14.4732 7.59785 13.5355 8.53553C12.5979 9.47322 11.3261 10 10 10C8.67392 10 7.40215 9.47322 6.46447 8.53553C5.52678 7.59785 5 6.32608 5 5C5 3.67392 5.52678 2.40215 6.46447 1.46447C7.40215 0.526784 8.67392 0 10 0ZM10 12.5C15.525 12.5 20 14.7375 20 17.5V20H0V17.5C0 14.7375 4.475 12.5 10 12.5Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"/></svg>`,
        ...
        `<svg xmlns="http://www.w3.org/2000/svg" width="21" height="26" viewBox="0 0 21 26" fill="none">
            <path d="M8.73861 0C9.73481 0.275626 10.2651 0.979129 10.5853 1.93726L13.0502 2.01601L13.1723 3.13426C13.7826 3.2537 16.6937 2.79564 16.6937 3.59101V14.7552L15.6503 14.3641V4.37458L15.4547 4.17902H13.3035L13.1736 5.74615H3.97816C3.60672 5.40227 3.84166 4.77621 3.7826 4.31027H1.43584V23.6356H11.0211C11.1221 23.6356 12.0789 24.3207 12.1301 24.5491H0.587958L0.392395 24.3535V3.2642C0.521021 3.3062 0.675896 3.13426 0.717896 3.13426H3.7826L3.80097 2.10788L6.50867 1.94644C6.63204 0.854441 7.34473 0.297939 8.34749 0.0013125H8.73861V0Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path>
            <path d="M20.6063 20.1089V20.5C20.454 20.7337 20.0419 21.2875 19.9855 21.5107C19.8844 21.911 20.0642 22.5699 19.891 22.852C19.803 22.9938 19.1507 23.2327 18.9236 23.4505C18.4761 23.8784 18.5023 24.5609 17.7949 24.6712C17.4694 24.721 17.1294 24.6384 16.7882 24.7079C16.3446 24.7985 16.1096 25.2421 15.5859 25.2145C15.1804 25.1935 14.9008 24.7867 14.5123 24.7079C14.0346 24.6108 13.4426 24.8155 13.0462 24.4782C12.8087 24.2748 12.7522 23.8128 12.5239 23.5647C12.2325 23.2497 11.5027 23.1001 11.3124 22.6893C11.1221 22.2785 11.2744 21.8073 11.1877 21.3781C11.109 20.9909 10.6916 20.6982 10.685 20.3071C10.6772 19.8333 11.109 19.6023 11.1904 19.2335C11.294 18.7596 11.0985 18.3029 11.3623 17.8383C11.5985 17.4235 12.2154 17.3526 12.4819 17.0652C12.6748 16.8578 12.8336 16.2423 13.1001 16.0506C13.4623 15.7895 14.0569 16.0113 14.5123 15.8971C14.8352 15.8157 15.0741 15.4193 15.5899 15.397C16.212 15.3708 16.3616 15.8065 16.7882 15.901C17.1701 15.9863 17.5836 15.8643 17.9327 15.9299C18.4656 16.031 18.5837 16.8565 18.9184 17.1623C19.1481 17.3723 19.7518 17.4642 19.891 17.7556C20.1206 18.2346 19.8411 19.5655 20.6076 20.1063L20.6063 20.1089ZM18.459 20.1653C18.459 18.6087 17.199 17.3474 15.645 17.3474C14.091 17.3474 12.831 18.6087 12.831 20.1653C12.831 21.722 14.091 22.9833 15.645 22.9833C17.199 22.9833 18.459 21.722 18.459 20.1653Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path><path d="M13.4045 12.2745H3.64606V13.3193H13.4045V12.2745Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path><path d="M13.4006 8.74261H3.66046V9.80049H13.4006V8.74261Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path><path d="M12.26 15.6687C11.8781 16.2895 11.8348 16.6465 11.0289 16.7226C9.57464 16.8604 5.63843 16.8998 4.24587 16.7016C3.91512 16.6544 3.73661 16.5769 3.6723 16.2278L3.77337 15.8603C3.84162 15.8196 3.94005 15.67 3.97812 15.67H12.26V15.6687Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path><path d="M10.3044 19.0641L9.84898 19.9789C9.75448 20.1246 9.60748 20.0971 9.4631 20.1154C8.57191 20.227 4.95859 20.2375 4.13433 20.0761C3.8469 20.0196 3.73271 19.9146 3.67365 19.6219L3.77471 19.2544C3.84296 19.2137 3.9414 19.0641 3.97946 19.0641H10.3044Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path><path d="M17.8644 20.1522C17.8644 21.3781 16.8709 22.373 15.6463 22.373C14.4217 22.373 13.4282 21.3781 13.4282 20.1522C13.4282 18.9263 14.4217 17.9315 15.6463 17.9315C16.8709 17.9315 17.8644 18.9263 17.8644 20.1522ZM15.3904 20.5H17.216L17.1583 20.101L15.9114 19.979C15.7618 19.828 16.2776 17.8566 15.4114 18.7583L15.3904 20.5Z" fill="${activeFlag?'var(--pc)':'#BBBBBB'}"></path>
        </svg>`,
