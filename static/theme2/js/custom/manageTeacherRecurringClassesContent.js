		    ...
		    +'<form name="recurringClassFilter" class="full" id="recurringClassFilter" action="javascript:void(0)">'
                ...
                html+= '<div class="col-md-3 col-sm-3 col-xs-12">'
                        ...
                        +'<div class="col-md-3 col-sm-6 col-xs-12">'
                            ...
                            +'<input type="text" name="startDate" id="startDate" class="form-control filterDates" value="" maxlength="10" readonly onkeydown="return false" />'
                        +'</div>'
                        +'<div class="col-md-3 col-sm-6 col-xs-12">'
                            +'<label>End Date</label>'
                            +'<input type="text" name="endDate" id="endDate" class="form-control filterDates" value="" maxlength="10" readonly onkeydown="return false" />'
                        +'</div>'
                        +'<div class="col-md-3 col-sm-6 col-xs-12">'
...
async function getRecurringClassesContentTeacher(titlle, roleAndModule, schoolId, userId, role){
	var html=
    ...
    await getTeacherAssignedGrade('recurringClassFilter', USER_ID)
