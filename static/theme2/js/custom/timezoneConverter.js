...
var DISPLAY_DAY_NAME_AND_MONTH_FULL_NAME_DATE_YEAR = "ddd, MMMM Do, YYYY"
var DISPLAY_DAY_NAME_AND_MONTH_FULL_NAME_DATE = "dddd, MMMM D"
var momentGlobal='';
var baseTimezone='';
	...
	'<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-left mb-1">'
		+'<div class="singleDateAndTime d-flex align-items-center h-100 flex-md-nowrap flex-wrap justify-content-end" style="gap:10px">'
			+'<span class="country-date w-100">'
				+'<input name="date" id="date" type="text" class="date date-picker form-control font-weight-semi-bold text-primary" value="" onchange="updateTime(this)" readonly onkeydown="return false">'
			+'</span>'
