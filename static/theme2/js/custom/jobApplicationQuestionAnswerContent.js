        ...
        `<div class="container py-4 mb-5">
            <div class="card rounded-10" style="max-widht:768px; width:100%;">
                <div class="card-body">
                        ...
                        <div class="col-lg-10">
                            <div class="d-flex justify-content-between align-items-center p-4 rounded-10" style="background:var(--pgc);">
                                ...
                                <div class="text-left bg-white rounded-10 p-2 font-12">
                                    <p class="mb-1"><i class="fa fa-calendar mr-1 text-warning"></i><span class="font-weight-bold">Validity Date:</span> ${formattedDate}</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <a href="javascript:void(0);" class="btn btn-lg btn-primary rounded-10 float-right font-16" onclick="submitAnswers('${entityId}', '${entityType}');"><i class="fa fa-paper-plane" aria-hidden="true"></i> Submit</a>
                        </div>
                    </div>
                </div>
            </div>
