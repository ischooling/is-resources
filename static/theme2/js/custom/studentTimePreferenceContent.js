                    ...
                    <div class="modal-body d-flex flex-wrap full px-1 py-3">
                        ...
                        ${CHAT_URL != ''?
                            `<div class="header-dots mr-0 position-relative ml-auto" style="min-width: 60px;">
                                <a target="_blank" href="${CHAT_URL}/onboarding-support?uuid=${UNIQUEUUID}" class="notify-bell-chat d-flex justify-content-center align-items-center group">
                                    ...
                                    <span class="chat-message" style="box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, .5) !important;">Live Chat with School Administration</span>
