...
function enrollmentPartnerBasicDetails(data){
	...
	'<div class="app-main w-100" style="padding-bottom: 60px;">'
		+'<form class="custom-field-scope" id="enrollmentPartnerForm">'
						...
						+'<div class="col-12 px-sm-2 px-0">'
							+'<div class="row">'
								...
								+'<div class="form-group custom-field mb-2">'
									+'<input type="text" id="firstName" name="firstName" value="'+data.details.firstName+'" class="form-control" required autocomplete="off" tabindex="3" placeholder=" ">'
								...
								+'<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">'
								+'<div class="form-group custom-field mb-2">'
									+'<input type="text" id="middleName" name="middleName" value="'+data.details.middleName+'" class="form-control" autocomplete="off" tabindex="4" placeholder=" ">'
								+'<label for="middleName">Middle Name</label>'
								+'</div>'
								+'</div>'
								+'<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">'
								+'<div class="form-group custom-field mb-2">'
									+'<input type="text" id="lastName" name="lastName" value="'+data.details.lastName+'"  class="form-control" required autocomplete="off" tabindex="5" placeholder=" ">'
								...
								+'<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 position-relative">'
									...
									if(data.details.otpVerifiedByWhatsapp=='W' || data.details.otpVerifiedByWhatsapp=='N'){
										if(data.details.otpVerifiedByWhatsapp=='W'){
											html+='<img src="'+PATH_FOLDER_IMAGE2+'watsapp-icon.png" width="16px" style="position:absolute;right:40px;top:14px" />';
										}
										html+='<img src="'+PATH_FOLDER_IMAGE2+'payment-sucess.png" width="16px" style="position:absolute;right:20px;top:14px"/>'
									}
								html+='<label for="whatsappNumber">Mobile Number*</label>'
								+'</div>'
								...
								+'<div class="form-group custom-field mb-2">'
									...
									// +'</div>'
								+'<label for="phoneNumber" style="margin-left: 7%;">Alternate Phone Number</label>'
								+'</div>'
								...
								+'<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2 individual-field">'
									...
									+'<div class="d-flex">'
										...
										+'<div class="form-group custom-field mb-2">'
											...
											html+='</select>'
										+'<label for="industryId">Select industry do you work in*</label>'
										+'</div>'
										+'<p class="m-0" id="industryIdError"></p>'
										+'</div>'
										+'<div class="w-100 ml-4 industrySpecify-wrapper" style="display:none">'
										+'<div class="form-group custom-field mb-2">'
											+'<input type="text" id="otherIndustry" name="otherIndustry" value="'+(data.details.industryId=='99'?data.details.industryOther:"")+'" class="form-control" rows="2" required tabindex="15" placeholder=" "/>'
								...
								+'<div class="form-group custom-field mb-2">'
									...
									+'<input type="text" id="organizationName" name="organizationName" value="'+data.details.organizationName+'" class="form-control" required autocomplete="off" tabindex="17" placeholder=" ">'
								+'<label for="organizationName">Name of the Company | Organization | Institution*</label>'
								+'</div>'
								...
								+'<div class="form-group custom-field mb-2">'
									...
									+'<input type="text" id="designation" name="designation" value="'+data.details.designation+'" class="form-control" required autocomplete="off" tabindex="18" placeholder=" ">'
								...
								+'<div class="form-group custom-field mb-2">'
									...
									html+='</select>'
									+'</select>'
								+'<label for="noOfEmployee">Total number of employees*</label>'
								+'</div>'
								...
								+'<label id="additionalInfoLabel" for="additionalInfo">Tell us more about you*</label>'
								+'</div>'
						...
						+'<div class="vertical-timeline-item vertical-timeline-element mb-4">'
							...
							+'<div>'
								...
								+'<div class="vertical-timeline-element-content bounce-in card p-2 rounded-10 " style="width:fit-content">'
									+ '<h6 class="font-weight-semi-bold m-0 ' + (data.applicationReceived.status=="done" ? 'text-primary' : (data.applicationReceived.status=="pending" ? 'text-light' : 'text-danger')) + '">' + data.applicationReceived.heading + '</h6>'
