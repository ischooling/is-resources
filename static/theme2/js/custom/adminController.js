...
const contentHandlers = {
    ...
    'school-settings': () => renderSchoolSettingDashboard('School Setting', roleAndModule, SCHOOL_ID, USER_ID, USER_ROLE),
    ...
    'lead-demo-report-country': () => renderLeadDemoReportCountryDashboard('Lead & Demo Report', roleAndModule, SCHOOL_ID, USER_ID, USER_ROLE),
    'lead-demo-dashboard': () => renderLeadDemoDashboard('Lead & Demo Dashboard', roleAndModule, SCHOOL_ID, USER_ID, USER_ROLE),
    'student-enrollment-dashboard': () => renderStudentEnrollmentDashboard('Enrollment Dashboard', roleAndModule, SCHOOL_ID, USER_ID, USER_ROLE),
    ...
    'parent-dashboard-demo-data': () => renderParentDashboardDemoDataPage('Dummy Parent Dashboard'),
    ...
    'student-council-club': () => renderClubsCommonPage("Student Council"),
    'the-debate-club': () => renderClubsCommonPage("The Debate Club"),
    'the-book-club': () => renderClubsCommonPage("The Book Club"),
    'the-art-club': () => renderClubsCommonPage("The Art Club"),
    'the-stem-club': () => renderClubsCommonPage("The STEM Club"),
    'the-gaming-club': () => renderClubsCommonPage("The Gaming Club"),
    'the-law-club': () => renderClubsCommonPage("The Law Club"),
    'the-global-exchange-club': () => renderClubsCommonPage("The Global Exchange Club"),
    'the-wellness-club': () => renderClubsCommonPage("The Wellness Club"),
    'the-newsletter-club': () => renderClubsCommonPage("The Newsletter"),
    'the-entrepreneurship-club': () => renderClubsCommonPage("The Entrepreneurship Club"),
    ...
    'student-dashboard-management': () => renderStudentDashboardManagementPage("Dummy Student Dashboard"),
