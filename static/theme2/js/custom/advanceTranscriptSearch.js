...
function getCallRequestForAdvanceTranscriptSearchStudent(formId, moduleId){
	...
	advanceTranscriptSearchDTO['startPosition'] = ($("#"+formId+" #startPosition").val() || '0').trim();
	advanceTranscriptSearchDTO['activeSession'] = $("#"+formId+" #activeSession").val();
	advanceTranscriptSearchDTO['numberOfRecords'] = ($("#"+formId+" #numberOfRecords").val() || '25').trim();
