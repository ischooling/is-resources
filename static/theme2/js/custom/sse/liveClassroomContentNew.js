  ...
  var html =
    '<div class="row mb-2 bg-light pt-2" style="font-size:12px !important">'
      +'<div class="col-lg-2 col-md-3 col-sm-6 col-12 mb-2">'
        ...
        +'<input type="text" class="form-control" id="startDate" placeholder="Select a date" style="font-size:12px !important" readonly/>'
      +'</div>'
      ...
      +'<div class="col-lg-2 col-md-3 col-sm-6 col-12 mb-2">'
        ...
        +'<input type="text" class="form-control" id="endDate" placeholder="Select a date" style="font-size:12px !important" readonly/>'
      +'</div>'
      +'<div class="col-lg-1 col-md-3 col-sm-6 col-12 mb-2">'
