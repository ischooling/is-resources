...
function getLeadFollowupFormB2BPopup(objRights){
	...
	html+='<input type="text" name="notSureCallscheduleDate" id="notSureCallscheduleDate" class="form-control dropdownFontSize datepicker" maxlength="50" autocomplete="off" readonly onkeydown="return false" data-date-orientation="top" data-date-z-index-offset="2000">';
	html+='</div>';
...
function getLeadAdvanceSearchB2BPopup(objectRights){
	...
	+'						<input type="text" name="leadStartDateSearch" id="leadStartDateSearch"  class="form-control datepicker" readonly onkeydown="return false" data-date-orientation="top" data-date-z-index-offset="2000">'
	+'					</div>'
	+'					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1">'
	+'						<label class="m-0">To Date</label>'
	+'						<input type="text" name="leadEndDateSearch" id="leadEndDateSearch"  class="form-control datepicker" readonly onkeydown="return false" data-date-orientation="top" data-date-z-index-offset="2000">'
	+'					</div>'
	+'					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1 utmSource">'
			...
			+'<div class="p-1 bg-light-primary border border-primary rounded-10 card">'
				+'<form class="col-12 mt-2 mb-2" method="post" id="addContractForm" action="javascript:void(0);">'
					...
					+'<div class="row">'
						...
						+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Name</label>'
							+'<input type="text" name="firstPartnerName" id="firstPartnerName" value="'+ (data.firstPartyRepresentative == undefined ? "": data.firstPartyRepresentative) +'" class="form-control txt-capitalize-case" maxlength="100">'
						+'</div>'
						+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Designation</label>'
							+'<input type="text" name="firstPartnerDesignation" id="firstPartnerDesignation" value="'+ (data.firstPartyDesignation == undefined ? "": data.firstPartyDesignation) +'" class="form-control txt-capitalize-case" maxlength="100">'
						+'</div>'
						...
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Name</label>'
							+'<input type="text" name="partnerName" id="partnerName" value="'+data.name+'" class="form-control txt-capitalize-case" maxlength="100">'
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Email</label>'
						...
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Designation</label>'
							+'<input type="text" name="partnerDesignation" id="partnerDesignation" value="'+ (data.secondPartyDesignation == undefined ? "" : data.secondPartyDesignation) +'" class="form-control txt-capitalize-case" maxlength="100">'
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Country</label>'
						...
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Starting Date of Contract</label>'
						...
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Effective End Date</label>'
						...
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Starting Date of Validity</label>'
						...
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Valid Till (Days)</label>'
						...
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-2">'
							+'<label class="m-0">Effective Validity End Date</label>'
