				...
				<td class="p-0">
					<div class="mb-3 card">
						<div class="card-header-tab card-header">
							...
							${item.callhippoCount > 0?`<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" data-original-title="CallHippo Logs"  id="wati_logs_link" onclick="getCallHippoLogs('${item.phoneNo.split(" ")[1]}')">
                   				 <img src="${PATH_FOLDER_IMAGE2}leadlist_icons/CallHippo.svg${SCRIPT_VERSION}" style="width:26px; margin-bottom: 4px;padding:4px;" />
							</a>`:''}
							${item.zadarmaCount > 0?`<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" data-original-title="Zadarma Logs"  id="wati_logs_link" onclick="getZadarmaLogs('${item.phoneNo.split(" ")[1]}')">
                   				 <img src="${PATH_FOLDER_IMAGE2}leadlist_icons/Zadarma.svg${SCRIPT_VERSION}" style="width:26px; margin-bottom: 4px;padding:4px;" />
							</a>`:''}
							</div>
						</div>
						<div class="card-body">
								<div class="p-2" style="background:#f0f9ff;">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <span class="field-value trans5s teacher-email-${item.userId}" useremail="${item.email}">${item.email}</span>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12">
			...
			+'<div class="card-body">'
				+'<form id="onboardedTeacherListForm">'
					+'<div class="row">'
						...
						+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">'
							+'<label>Grade</label>'
							+'<select id="gradeId" class="form-control selectReset" disabled>'
						...
						<div id="maillogsRecordsWrapper">
							<table class="table table-bordered font-12 border-radius-table" id="maillogsRecordsTable" style="width:100%">
								<thead>
									<tr>
										<th class="bg-primary text-white font-weight-normal border-bottom-0 vertical-align-middle rounded-top-left-10" style="5% !important">Sr no.</th>
										<th class="bg-primary text-white font-weight-normal border-bottom-0 vertical-align-middle">Teacher Name</th>
									...
									<div class="full mb-1 mt-1 table-responsive" style='max-height: 500px;overflow-y: auto;'>
										<table id="emailBroadcastSendTable" class="table" style="font-size:14px;min-width:450px;">
											...
											$.each($("input[name='teacher-move-another']:checked"), function(index, checkbox) {
                                                var userId = $(checkbox).val(); 
                                                var name = $(".teacher-name-" + userId).attr("teachername") || '';
                                                var email = $(".teacher-email-" + userId).attr("useremail")?.trim()
												html+=`<tr id="esmsgcol_`+userId+`">
															<td>
																<div class="custom-checkbox custom-control">
																	<input type="checkbox"
