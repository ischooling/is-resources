                    ...
                    $.each(data, function (key, value) {
                        html += '<tr id="schoolSettingRow'+key+'">'
                                ...
                                //+ '<td>'+ value.startDate + '</td>'
                                 ...
                                 + '<input type="text" class="d-none inputValue sessionStartDate" id="sessionStartDate' + value.sessionId + '" value="' + value.startDate + '" readonly />'
                                 + '</td>'
                               //+ '<td>'+ value.endDate + '</td>'
                                + '<td>'
                                + '<span class="textValue">' + value.endDate + '</span>'
                                + '<input type="text" class="d-none inputValue sessionEndDate" id="sessionEndDate' + value.sessionId + '" value="' + value.endDate + '" readonly/>'
                                + '</td>'
                                //+ '<td>'+ value.leadStartDate + '</td>'
                                + '<td>'
                                 + '<span class="textValue">' + value.leadStartDate + '</span>'
                                 + '<input type="text" class="d-none inputValue sessionStartDate" id="leadStartDate' + value.sessionId + '" value="' + value.leadStartDate + '" readonly/>'
                                 + '</td>'
                                //+ '<td>'+ value.leadEndDate + '</td>'
                                + '<td>'
                                 + '<span class="textValue">' + value.leadEndDate + '</span>'
                                 + '<input type="text" class="d-none inputValue sessionEndDate" id="leadEndDate' + value.sessionId + '" value="' + value.leadEndDate + '" readonly/>'
                                 + '</td>'
