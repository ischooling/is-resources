										...
										+'<div class="row">'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
													+'<div class="w-100 hideTimeAvailableDate">'
														...
														+'<input type="text" class="form-control" name="timeAvailableDateFrom" id="timeAvailableDateFrom" readonly>'
													+'</div>'
											+'</div>'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate">'
											...
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate">'
													...
													+'<input type="text" class="form-control" name="timeAvailableDateTo" id="timeAvailableDateTo" readonly>'
												+'</div>'
											+'</div>'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate">'
				   ...
				   +'<div class="modal-body overflow-auto">'
					   +'<div class="row">'
						   ...
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   ...
							   +'<input type="text" class="form-control datepicker" name="meetingDate" id="meetingDate" autocomplete="off" readonly>'
						   +'</div>'
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<label class="m-0">Start Time</label>'
