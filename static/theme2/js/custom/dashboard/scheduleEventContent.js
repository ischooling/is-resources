					...
					+'<div class="row">'
						...
						+'<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
							...
							+'<div class="d-flex" style="gap: 8px;">'
								+'<input class="form-control-sm form-control datepicker" type="text" name="startDate" id="startDate" readonly>'
								+'<input class="form-control-sm form-control datepicker" type="text" name="endDate" id="endDate" readonly>'
							+'</div>'
						+'</div>'
						+'<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
