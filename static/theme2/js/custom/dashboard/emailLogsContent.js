function getEmailLogsContent(title, newTheme) {
	$("#emailLogForm" + " #getEmail").val("");
	$("#emailLogForm" + " #startDate").val("");
	$("#emailLogForm" + " #endDate").val("");
	$("#emailLogForm" + " #getSubject").val("");
	$("#emailLogForm" + " #getContent").val("");
	$("#emailLogForm" + " #attachement").val("");
	var html = 
					...
					html+='<div class="card-body">'
								+'<form id="emailLogForm" action="javascript:void(0);">'
									+'<div class="row p-4">'
										...
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Subject</label>'
											+'<input type="text" id="getSubject" class="form-control" />'
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Content</label>'
											+'<input type="text" id="getContent" class="form-control" />'
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Attachment</label>'
										...
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Order by field</label>'
										...
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Page Number</label>'
											+'<input type="text" id="pageNo" class="form-control" autocomplete="off" />'
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Page Size</label>'
											+'<input type="text" id="pageSize" class="form-control" value="100" autocomplete="off" />'
										+'</div>'
										+'<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">'
											+'<label class="m-0 full">Sort by</label>'
										...
										+'<div class="col-xs-12 text-right">'
											...
											+'<button class="btn btn-sm btn-primary" onclick="resetForm(\'emailLogForm\')">Reset</button>'
										+'</div>'
									+'</div>'
								+'</form>'
							+'</div>'
