...
function getAssignedGradeStudentTeacher(teacherAssignGradeDTO){
	...
	$('#assignedgradeStudentTable tbody').html('');
				...
				+'<td data-label="Total" text-color="#fff" style="background-color:var(--pc) !important">'
...
function validateRequestForTeacherComp(formId,teacherId,standardId,controlType,index,employeType){
	...
	if(employeType=="Full-Time"){
		if($("#"+formId+" #noOfSessionFT_"+index).val()=="" || $("#"+formId+" #noOfSessionFT_"+index).val()=="0"){
			showMessageTheme2(0,"Please enter Hours per week.");
			return false
		}
		if($("#"+formId+" #amountInrFT_"+index).val()=="" && $("#"+formId+" #amountUsdFT_"+index).val()==""){
			showMessageTheme2(0,"Basic Salary field is mandatory.");
			return false
		}
		if($("#"+formId+" #perclassAmountFT_"+index).val()=="" || $("#"+formId+" #perclassAmountFT_"+index).val()==0){
			showMessageTheme2(0,"Per Class Amount in Percentage field is mandatory.");
			return false
		}
		if($("#"+formId+" #perclassAmountFT_"+index).val()!='' && $("#"+formId+" perclassAmountFT_"+index).val()!=undefined && $("#"+formId+" perclassAmountFT_"+index).val()!=0){
			if($("#perclassAmountFT_"+index).val()>100){
				showMessageTheme2(0,"Per Class Amount Percentage can not be more than 100.");
				return false;
			}
		}
		...
		if($("#"+formId+" .endCompDateFT_"+index).val()!=''){
			if($("#"+formId+" .startCompDateFT_"+index).val()>$("#"+formId+" .endCompDateFT_"+index).val()){
				showMessageTheme2(0,"End Date must be greater than start date.");
				return false
			}
		}
	}else{
		...
		if(employeType=="Full-Time"){
			...
			showMessageTheme2(0,"Please enter No of session.");
		}
		return false
	}

	if($("#"+formId+" #sessionType_"+index).val()==''){
		showMessageTheme2(0,"Session type is required.");
		return false
	}
	if($("#"+formId+" #durationSession_"+index).val()=='0'){
		showMessageTheme2(0,"Duration of Complimentary session is required.");
		return false
	}

	if($("#"+formId+" #amountInr_"+index).val()==""){
		showMessageTheme2(0,"Amount field is mandatory.");
		return false
	}
...
function getSaveAttendanceRequest(attendanceid, attendminuts,remark,  calltype){
	if(calltype=='save'){
		if($('#atttimeHrsFrom').val()=='' || $('#atttimeHrsFrom').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please select start hours");
			}else{
		...
		if($('#atttimeMinFrom').val()=='' || $('#atttimeMinFrom').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please select start minutes");
			}else{
		...
		if($('#atttimeSecFrom').val()=='' || $('#atttimeSecFrom').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please select start second");
			}else{
		...
		if($('#atttimeHrsTo').val()=='' || $('#atttimeHrsTo').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please select end hours");
			}else{
		...
		if($('#attmeetingtopic').val()=='' || $('#attmeetingtopic').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please fill meeting topic");
			}else{
		...
		if($('#attremark').val()=='' || $('#attremark').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please fill remark");
			}else{
		...
		// 	if(tt=='theme1'){
		// 		showMessageTheme2(0, "Please fill meeting recording url");
		// 	}else{
		...
		// 	if(tt=='theme1'){
		// 		showMessageTheme2(0, "Please fill recording passcode");
		// 	}else{
		...
		if($('#attmeetingid').val()=='' || $('#attmeetingid').val()==undefined){
			if(tt=='theme1'){
				showMessageTheme2(0, "Please fill meeting id");
			}else{
