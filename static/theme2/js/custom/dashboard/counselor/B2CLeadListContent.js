...
function getLeadFollowupFormPopup(objRights){
	...
	+'								<input type="text" name="notSureCallscheduleDate" id="notSureCallscheduleDate" class="form-control dropdownFontSize datepicker" maxlength="50" autocomplete="off" readonly>'
	+'							</div>'
	...
	+'										<input type="text" name="tentativeDate" id="tentativeDate" value="" class="form-control datepicker" maxlength="50" autocomplete="off" readonly />'
	+'									</div>'
	+'								</div>'
	+'								<div class="row">'
...
function getLeadAdvanceSearchPopup(objRights){
	...
	+'	<input type="text" name="leadStartDateSearch" id="leadStartDateSearch" value="'+objRights.startDate+'" class="form-control datepicker" readonly>'
	+'</div>'
	+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1">'
	+'	<label class="m-0">To Date</label>'
	+'	<input type="text" name="leadEndDateSearch" id="leadEndDateSearch" value="'+objRights.endDate+'" class="form-control datepicker" readonly>'
	+'</div>'
	+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1 utmSource">'
           ...
           +' <div class="modal-body">'
                +'<form class="col-lg-12 col-md-12 col-ms-12 col-12 pt-2 pb-2" method="post" action="javascript:void(0);" id="leadCampaignForm">'
                  +' <div class="row">'
						...
						+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1">'
							+'<label class="m-0">Start Date</label>'
							+'<input type="text" name="campaignStartDate" id="campaignStartDate"  class="form-control" readonly>'
						+'</div>'
						+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1">'
