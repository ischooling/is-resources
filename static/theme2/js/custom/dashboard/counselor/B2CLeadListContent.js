...
function getLeadAdvanceSearchPopup(objRights){
	...
	+'	<input type="text" name="leadStartDateSearch" id="leadStartDateSearch" value="'+objRights.startDate+'" class="form-control datepicker" readonly onkeydown="return false">'
	+'</div>'
	+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1">'
	+'	<label class="m-0">To Date</label>'
	+'	<input type="text" name="leadEndDateSearch" id="leadEndDateSearch" value="'+objRights.endDate+'" class="form-control datepicker" readonly onkeydown="return false">'
	+'</div>'
	+'<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-1 mt-1 utmSource">'
									...
									+'<td colspan="2" class="border-0 p-0 pr-1">'
										+'<table style="width:100%;" id="remarkTable">'
											+'<tbody>'
												...
												+'<tr>'
													+'<td>'
													+'<textarea class="form-control followupRemarks-suggestion" data-leadid="'+leads.leadId+'" name="followupRemarks-'+leads.leadId+'" id="followupRemarks-'+leads.leadId+'" rows="2" style="height: 50px !important;"></textarea>'
													+'<div class="suggestionslead" id="suggestions-'+leads.leadId+'"></div>'
													+'</td>'
												+'</tr>'
												+'<tr>'
													+'<td>'
