				...
				+'<tr class="td-border-design">'
					...
					+'<td class="rounded-bottom-right-10 '+ltype+'-'+(leads.callBadge!=''?leads.callBadge+'-bg':'')+'">'
						+'<table class="w-100">'
							...
							html+='<tr>'
									+'<td colspan="2" class="border-0 p-1">'
										+'<a id="addContractB2b_'+leads.rawLeadId+'" href="javascript:void(0)" onclick="getB2BContractDetails(\''+leads.rawLeadId+'\', \'add\', \'\')" class="text-dark py-1 '+(parseInt(leads.contractsCount) == 0 && leads.leadFollowStatus.trim() == "Converted & On Boarding | Hot" ? "d-inline-block":"d-none")+'"><i class="fa fa-plus-square text-primary"></i>&nbsp;Add Contract</a>'
					...
					+'<div class="row">'
						+'<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">'
							...
							+'<select name="contractPartnerType" id="contractPartnerType" class="form-control" data-partner-user-id="'+data.PUserId+'">'
								...
								+'<option value="EPR">Enrollment Partner with Enrollment Rights</option>'
						...
						+'<div class="col-12">'
							+'<h6 class="font-weight-bold">Contract Duration</h6>'
						+'</div>'
						+'<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">'
						...
						+'<hr/>'
						+'<div class="col-12 mb-2">'
							+'<h6 class="font-weight-bold ml-2 mt-2">Set the Validity for Offer of Acceptance</h6>'
