...
function getZoomCommandContent(aggrigatorName, aggrigatorStatus, aggregatorId, aggregatorIdUserId, userKey, groupId) {
	...
	// 	html = '<a href="javascript:void(0);" onclick="return showAggrigatorStatusPopup(\'Are you sure you want to create the ' + aggrigatorName + ' user?\', \'create\', ' + aggregatorId + ', ' + aggregatorIdUserId + ',\'' + aggrigatorName + '\',\'' + userKey + '\',\'' + groupId + '\');">Create<br></a>'
	// } else if (aggrigatorStatus == 'A') {
	// 	if (aggrigatorName == 'ZOOM') {
	// 		if (groupId == '') {
	// 			html = 'Invitation sent'
	// 		} else if (groupId != '') {
	// 			html = '<a href="javascript:void(0);" onclick="return showAggrigatorStatusPopup(\'Are you sure you want to unlink the ' + aggrigatorName + ' user?\', \'unlink\', ' + aggregatorId + ', ' + aggregatorIdUserId + ',\'' + aggrigatorName + '\',\'' + userKey + '\',\'' + groupId + '\');">Unlink<br></a>'
	// 		}
	// 	} else {
	// 		html = '<a href="javascript:void(0);" onclick="return showAggrigatorStatusPopup(\'Are you sure you want to unlink the ' + aggrigatorName + ' user?\', \'unlink\', ' + aggregatorId + ', ' + aggregatorIdUserId + ',\'' + aggrigatorName + '\',\'' + userKey + '\',\'' + groupId + '\');">Unlink<br></a>'
	// 	}
	// } else if (aggrigatorStatus == 'U') {
	// 	html = '<a href="javascript:void(0);" onclick="return showAggrigatorStatusPopup(\'Are you sure you want to create the ' + aggrigatorName + ' user?\', \'active\', ' + aggregatorId + ', ' + aggregatorIdUserId + ',\'' + aggrigatorName + '\',\'' + userKey + '\',\'' + groupId + '\');">Create<br></a>'
	// }
	// html = '<div id="' + aggrigatorName + '_aggrigatorUserId_' + aggregatorIdUserId + '">'
	// 	+ aggrigatorName + ' ' + html
	// 	+ '</div>';
