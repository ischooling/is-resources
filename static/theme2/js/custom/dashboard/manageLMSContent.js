		...
		+'<form name="lmsStudentFilter" id="lmsStudentFilter" action="javascript:void(0)">'
			+'<div class="filter-fields d-flex flex-wrap">'
				...
				+'<div class="col-md-3 col-sm-6 col-xs-12">'
					...
					+'<input type="text" name="academicYearStartDate" id="academicYearStartDate" class="form-control filterDates" value="" maxlength="10" readonly/>'
				+'</div>'
				+'<div class="col-md-3 col-sm-6 col-xs-12">'
					+'<label>End Date</label>'
					+'<input type="text" name="academicYearEndDate" id="academicYearEndDate" class="form-control filterDates" value="" maxlength="10" readonly/>'
				+'</div>'
