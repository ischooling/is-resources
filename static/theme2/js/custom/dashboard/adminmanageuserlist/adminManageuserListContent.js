			...
			<div class="filter-fields rounded-10" style="display:none">
				<div class="row px-3">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						...
						<input type="text" name="addedDate" class="form-control" id="addedDate">
					</div>
					<div class="col-md-4 col-sm-6 col-xs-12">
						<label>Status</label>
											...
											<td>
												<div class="btn-group">
													<button type="button" class="btn btn-danger  dropdown-toggle  btn-sm"
														...
														aria-expanded="false" data-toggle="tooltip" title="Action" style="background-color:#007fff !important;border-color:#007fff;box-shadow:none;">
