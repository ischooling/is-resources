function notEligibleForRequest(userId, schoolWebsite, logoUrl, copyrightYear, copyrightUrl) {
	...
	// Check if MAINTENANCEDOWNTIME is not an empty string
									...
									<div class="card-body p-1">
										...
										<div id="paymentScheduleDiv" class=" " style="display:none;">
											<div class="row">
												...
												<div id="saveNConfirm" class="col-lg-2 col-md-4 col-sm-12 col-12 text-right"></div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-2 px-0" id="paymentScheduleDiv">
											...
											<div id="saveNConfirm" class="full mt-1 mb-2 text-right"></div>
										</div>
									</div>
								</div>
							</div>
		...
		`<div class="card is-water-mark full mt-2 py-1">
			<div class="card-body col py-1">
				...
				<div class="table-respnsive">
					<table id="paymentScheduleTableOnetime" class="table table-bordered table-striped border-radius-table font-12 nowrap" style="min-width:560px;">
						<thead>
						...
						<tbody>`;
							if(responseData == '' || responseData.schedulePayments == null) {
								...
								`<tr>
									...
									<td><input type="text" id="installment1" class="form-control dataPicker schedulePayDate" value="" readonly onkeydown="return false"/></td>
									<td class="paymentTitle">${gradeName} - One Time Payment - Advance</td>
									<td class="text-right installment1 scheduleFeeInput d-flex align-items-center">${currency}<input type="text" class="installmentValue ml-1" id="ad_installment1" value="${installment1}" readonly onkeydown="return false" ></td>
					...
					<tbody>`;
						if(responseData == '' || responseData.schedulePayments == null) {
							...
							<tr>
								...
								<td><input type="text" id="installment2" class="form-control dataPicker schedulePayDate" value="" readonly onkeydown="return false"/></td>
							...
							<tr>
								...
								<td><input type="text" id="installment3" class="form-control dataPicker schedulePayDate" value="" readonly onkeydown="return false"/></td>
