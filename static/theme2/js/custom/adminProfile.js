...
async function saveProfileDetails(formId, arg0) {
    ...
    var requestDate = {
        ...
        countryTimezoneId: $("#countryTimezoneId option:selected").attr("custom_timezone_id"),
        isdCode: $('#isdCode').val(),
        userId: $('#userId').val(),
    ...
    if(responseData.statusCode == "SUCCESS"){
        showMessageTheme2(1, "Profile Update Successfully", "", true);
