		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				...
				<form class="form-horizontal w-100" method="post" action="javascript:void(0);" id="studentAssignCounselorDataForm">
					...
					<table class="table table-bordered table-striped text-center border-radius-table" id="studentAssignCounselor" style="width:100%;min-width:1200px;font-size:11px">
