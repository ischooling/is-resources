						...
						+'<div class="row">'
							+'<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 mt-2">'
								+'<div class="full custom-radio custom-control p-0">'
									+'<p class="d-flex" style="gap: 60px;">Filling this Interest Form'
									...
									+'<label for="asAnIndividual" class="d-flex custom-control-label align-items-center mb-0">As an Individual</label></p>'
								+'</div>'
							+'</div>'
							+'<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 mt-2">'
