...
function getRequestForSchoolPaymentFilter(formId) {
    ...
    if(USER_ROLE == 'DIRECTOR'){
        ...
        if(USER_ROLE == 'SCHOOL_ADMIN'){
            schoolPaymentFilterDTO['fromSchoolId'] =  $("#" + formId + " #schoolName").attr('data-schoolId') == undefined ? SCHOOL_ID : $("#" + formId + " #schoolName").attr('data-schoolId');
        }else{
            schoolPaymentFilterDTO['fromSchoolId'] =  ($("#" + formId + " #schoolName").attr('data-schoolId') == undefined || $("#" + formId + " #schoolName").attr('data-schoolId') == "") ? "ALL" : $("#" + formId + " #schoolName").attr('data-schoolId');
        }
    }
...
async function getPartnerSchoolList(){
    if(USER_ROLE == "DIRECTOR"){
        ...
        $('#schoolName').attr("data-schoolId",SCHOOL_ID);
