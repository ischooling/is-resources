					...
					+'<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">'
						+'<div class="d-flex align-items-end flex-wrap ">'
							...
							+'<div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3">'
								...
								+'<input class="form-control" type="text" id="startDate" autocomplete="off" readonly onkeydown="return false"/>'
							+'</div>'
							+'<div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-xs-12 mt-3">'
								+'<label>End Date</label>'
								+'<input class="form-control" type="text" id="endDate" autocomplete="off" readonly onkeydown="return false"/>'
							+'</div>'
