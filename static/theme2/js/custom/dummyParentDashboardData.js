...
(function (window) {
    ...
    function getDummyProgressCourseHtml(student, course, reportIndex, index) {
        ...
        return "<div class='headerSection'>"
            ...
            + "<tr><td colspan='2'><div class='right-part text-center mt-1' style='width:auto;'><div class='right-title m-0'><h3 class='text-center text-uppercase bold'>Detailed Student Grading Report</h3><h4 class='text-uppercase bold'>Duration: " + moment(getDummyBaseDate()).subtract((reportIndex * 7) - 1, "days").format("MMM DD, YYYY") + " - " + moment(getDummyBaseDate()).subtract((reportIndex - 1) * 7, "days").format("MMM DD, YYYY") + "</h4></div></div></td></tr>"
            + "</thead></table></div></div>"
            ...
            + "<tr><td style='text-align:right;font-weight:bold'>Course Completion Percentage:</td><td>" + (72 + (index * 8)) + "%</td></tr>"
