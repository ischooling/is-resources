async function renderTeacherAvailability(moduleId){
   ...
   function setTimeAvailableDateTo(selectedDateStart){
	...
	if(typeof refreshCustomFieldState === 'function'){
		refreshCustomFieldState($('#teacherFilterTime'));
		refreshCustomFieldState($('#recommendedTeacherlistForm'));
		refreshCustomFieldState($('#bookAClassModal'));
		refreshCustomFieldState($('#addAvailiblityModal'));
	}
			  ...
			  +'<div class="col p-0">'
				   +'<div class="app-main__inner">'
						...
						+'<div class="main-card mb-3 card">'
							 ...
							 +'</div>'
							 +'<form id="teacherFilterTime" class="custom-field-scope">'
								+'<div class="row mt-2">'
									+'<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											+'<input type="text" class="form-control" name="teacherName" id="teacherName" value="" placeholder=" ">'
											+'<label class="text-primary m-0">Teacher Name</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											+'<input type="text" class="form-control" name="teacherEmail" id="teacherEmail" value="" placeholder=" ">'
											+'<label class="text-primary m-0">Teacher Email</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											...
											+'<label class="text-primary m-0">LMS Platform</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-md-2 col-sm-6 col-xs-12">'
										+'<div class="custom-field">'
											...
											+'</select>'
											+'<label class="text-primary m-0">Select Grade</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-md-2 col-sm-6 col-xs-12">'
										+'<div class="custom-field">'
											...
											+'</select>'
											+'<label class="text-primary m-0">Select Course Category</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-md-2 col-sm-6 col-xs-12">'
										+'<div class="custom-field">'
											...
											+'</select>'
											+'<label class="text-primary m-0">Select Course</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											...
											+'</select>'
											+'<label class="text-primary m-0">Profile Status</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											...
											+'<label class="text-primary m-0">Time Zone From</label>'
										+'</div>'
									+'</div>'
									+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											+'<select class="form-control" name="timeZoneTo" id="timeZoneTo"></select>'
											+'<label class="text-primary m-0">Time Zone To</label>'
										+'</div>'
									+'</div>'
									...
									+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">'
										+'<div class="custom-field">'
											...
											+'</select>'
											+'<label class="text-primary m-0">Select Date (UTC +8:00)</span></label>'	
										+'</div>'
									+'</div>'
									+'<div class="col-xl-10 col-lg-8 col-md-8 col-lg-8"> '
										+'<div class="row">'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
													+'<div class="w-100 hideTimeAvailableDate custom-field">'
														+'<input type="text" class="form-control" name="timeAvailableDateFrom" id="timeAvailableDateFrom" readonly onkeydown="return false" placeholder=" ">'
														+'<label class="text-primary m-0">Start Date</label>'
													+'</div>'
											+'</div>'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate custom-field">'
													+'<select class="form-control" name="startTime" id="startTime" style="font-size:11px !important"></select>'
													+'<label class="text-primary m-0">Start Time</label>'
												+'</div>'
											+'</div>'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate custom-field">'
													+'<input type="text" class="form-control" name="timeAvailableDateTo" id="timeAvailableDateTo" readonly onkeydown="return false" placeholder=" ">'
													+'<label class="text-primary m-0">End Date</label>'
												+'</div>'
											+'</div>'
											+'<div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-2 ">'
												+'<div class="w-100 hideTimeAvailableDate custom-field">'
													+'<select class="form-control" name="endTime" id="endTime" style="font-size:11px !important"></select>'
													+'<label class="text-primary m-0">End Time</label>'
												+'</div>'
											+'</div>'
											+'<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">'
												+'<div class="w-100 text-right">'
													+'<label class="text-primary m-0">&nbsp;</label>'
		   ...
		   +'<div class="modal-dialog modal-lg p-0 float-right">'
			   +'<div class="modal-content">'
				   +'<div class="modal-header bg-primary py-2">'
					   ...
					   +'</button>'
				   +'</div>'
				   +'<div class="modal-body overflow-auto custom-field-scope">'
					   +'<div class="row">'
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<div class="custom-field">'
						   ...
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<div class="custom-field">'
								   +'<input type="text" class="form-control datepicker" name="meetingDate" id="meetingDate" autocomplete="off" readonly onkeydown="return false" placeholder=" ">'
								   +'<label class="m-0">Start Time</label>'
							   +'</div>'
						   +'</div>'
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<div class="custom-field">'
								   +'<input type="text" class="form-control timepicker" name="statrTime" id="statrTime" autocomplete="off" placeholder=" ">'
								   +'<label class="m-0">Start Time</label>'
							   +'</div>'
						   +'</div>'
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<div class="custom-field">'
								   +'<input type="text" class="form-control" value="50" name="duration" id="duration" disabled placeholder=" ">'
			   ...
			   +'<div class="modal-content">'
				   ...
				   +'<div class="modal-body overflow-auto custom-field-scope">'
					   +'<div class="row">'
						   ...
						   +'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">'
							   +'<div class="custom-field">'
								   +'<input type="text" class="form-control timepicker" name="endTime" id="endTime" autocomplete="off" placeholder=" ">'
	   ...
	   +'<div class="modal-dialog modal-xl p-0 float-right">'
		   +'<div class="modal-content">'
			   ...
			   +'<div class="modal-body overflow-y-auto">'
				    +'<form id="recommendedTeacherlistForm" class="full custom-field-scope">'
...
function recommendedTeacherlistFilterForm(){
	var html = '<div class="row custom-field-scope">'
					+'<div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12 mb-2">'
						+'<div class="custom-field">'
							...
							+'<input type="text" class="form-control" id="typeahead" name="typeahead" placeholder=" " />'
				...
				+'<div class="row">'
					+'<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">'
						+'<label class="m-0 font-weight-bold mb-2">Add Student Preference (You can add upto 3 preferences)</label>'
					+'</div>'
					...
					+'</span>'
					+'<div class="d-inline-block align-top" id="timePreferenceSlotWrapper" style="margin-top:-8px;margin-bottom:0 !important;"><span id="notSlotAdd" class="d-inline-block position-relative font-weight-bold" style="top:20px">No Time Preference Added.</span></div>'
...
function timePreferenceSlots(slotList){
	var html = '';
		$.each(slotList, function(i, v){
			html+='<span class="d-inline-block ml-2 selectedPreferenceSlot" id="selectedPreferenceSlot'+i+'" startTime="'+v.startTime+'" endTime="'+v.endTime+'" style="margin-top:-8px;vertical-align:top;">'
