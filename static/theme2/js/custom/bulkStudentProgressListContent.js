		...
		<div class="modal-content text-center">
			...
			<div class="modal-footer text-center">
				<div class="text-center" style="margin: 0 auto;">
					<button id='generateReportWarningYes' type="button" class="btn btn-outline-primary">Yes</button>
					<button id='generateReportWarningNo' type="button" class="btn btn-outline-primary" data-dismiss="modal">No</button>
