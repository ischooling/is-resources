	...
	var tableHtml='';
		$.each(userLeaveDTO, function (index, value) {
			...
			if(value.status != 'Initiated' && value.status != 'Panding' && value.status != 'panding' && USER_ROLE == "TEACHER"){
				tableHtml += '<button type="button" class="btn btn-danger  dropdown-toggle  btn-sm"data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="tooltip" title="Action" style="background-color:var(--pc) !important;border-color:var(--pc);box-shadow:none;" disabled>' +
			'<i class="fa fa-ellipsis-v"></i>' +
			'</button>';
			}else{
				tableHtml += '<button type="button" class="btn btn-danger  dropdown-toggle  btn-sm"data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="tooltip" title="Action" style="background-color:var(--pc) !important;border-color:var(--pc);box-shadow:none;">' +
			'<i class="fa fa-ellipsis-v"></i>' +
			'</button>';
			}
