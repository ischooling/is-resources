					...
					+'<div class="row">'
						...
						+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-1 mt-1">'
							+'<div class="form-group position-relative custom-field mb-0">'
								...
								+'</select>'
								+'<label class="mb-0" for="chatSupport">Chat Support</label>'
							+'</div>'
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-1 mt-1">'
							+'<div class="form-group position-relative custom-field mb-0">'
								+'<input type="text" name="chatDate" id="chatDate" class="form-control" placeholder=" " readonly onkeydown="return false">'
								+'<label class="mb-0" for="chatDate">Select chat date</label>'
							+'</div>'
						+'</div>'
						+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-1 mt-1">'
							+'<label class="m-0 full">&nbsp;</label>'
								+'<div class="full position-relative" style="width: 160px !important; max-width: 160px !important;" id="OD3div" uploaded="" fileName="" docType="Chat documents" thumbType="" data-PDFURL="" >'
									...
									+'<label class="upload-label form-control mb-0 btn btn-primary" style="width: 160px !important;"><i class="fa fa-upload mr-2"></i>Upload</label>'
								+'</div>'
			...
			+'<div class="modal-content border-0">'
				...
				+'<div class="modal-body">'
					+'<div class="row">'
						...
						+'<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-1 mt-1">'
							+'<label class="m-0 full">&nbsp;</label>'
								+'<div class="full position-relative" style="width: 160px !important; max-width: 160px !important;" id="OD3div" uploaded="" fileName="" docType="B2B attachments" thumbType="" data-PDFURL="" >'
									+'<input type="file" id="OD3" class="upload-input form-control" onchange="cropImageChatSupport(event,\'OD3\',\'OD3Icon\',\'OD3div\',\'Chat documents\',\'\',\'OD3ViewAndRemoveBtn\',3)">'
									+'<label for="OD3" class="upload-label form-control mb-0 btn btn-primary" style="width: 160px !important;"><i class="fa fa-upload mr-2"></i>Upload</label>'
								+'</div>'
							+'<div class="full" id="OD3ViewAndRemoveBtn" style="display: none;">'
								+'<a id="OD3View" href="javascript:void(0);"  class="btn btn-outline-success mr-2" onclick="viewAttachmentChatSupport(this, \'uploadFile\',\'I\',\'OD3div\')">'
									+'<i class="fa fa-eye mr-2"></i>View'
