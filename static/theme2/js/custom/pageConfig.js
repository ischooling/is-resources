...
async function callDashboardPageSchool(moduleId, pageNo, replaceDiv, extraParam, extraParam1) {
    ...
    var pageRequest = {
        ...
        "manage-batch-student":{url:"",file:[{role:"",fileName:["ManageBatchStudentContent.js","dashboardSchoolBatches.js","commonActivityModel.js","batchCalendarRender.js"]},{role:"js",fileName:["timepicker.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "manage-motivational-quotes":{url:"",file:[{role:"",fileName:["MotivationalQuotesContent.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "financial-cost":{url:"",file:[{role:"",fileName:["FinancialCostContent.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "lead-analytics":{url:"",file:[{role:"",fileName:["LeadAnalyticsContent.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "re-enrollment-list":{url:"",file:[{role:"",fileName:["reEnrollmentListContent.js","reEnrollmentList.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "live-classroom-status":{url:"",file:[{role:"",fileName:["liveClassroomContentNew.js","liveClassroomNew.js","serverSendEventForClass.js","masterContent.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "lead-report-list":{url:"",file:[{role:"",fileName:["LeadReportListContent.js","EnrollmentAnalyticsContent.js","CounselorDashboardContent.js","leads.js","LeadReportSearchPopup.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "lead-report-campaign":{url:"",file:[{role:"",fileName:["LeadReportCampaignContent.js","LeadReportListContent.js","EnrollmentAnalyticsContent.js","CounselorDashboardContent.js","leads.js","LeadReportSearchPopup.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "lead-detail-by-campaign":{url:"",file:[{role:"",fileName:["LeadReportListContent.js","EnrollmentAnalyticsContent.js","CounselorDashboardContent.js","leads.js","LeadReportSearchPopup.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "lead-list":{url:"",file:[{role:"",fileName:["LeadListContent.js","B2CLeadListContent.js","B2CLead.js","B2BLeadListContent.js","leads.js","leadsContent.js","leadsPartnerContent.js","leadsPartner.js","schoolSetupContent.js","cropperImageChatSupportDocument.js","cropperImageLeadDocument.js", "schoolSetup.js", "CounselorData.js", "forceLeadsUpdate.js","commonRecordings.js","DownloadReportsContent.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        "lead-assign-form":{url:"",file:[{role:"",fileName:["leadAssignFormContent.js","leadAssignForm.js","leads.js","scheduledEventRecordingAccess.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "lead-demo-report-country":{url:"",file:[{role:"",fileName:["leadDemoReportCountryContent.js","leadDemoReportCountry.js","leads.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        "extra-activity":{url:"add-extra-activity?moduleId="+moduleId,file:[{role:"",fileName:["dashboardExtraActivity.js","commonActivityModel.js","scheduleEventContent.js","scheduleEvent.js", "commonRecordingsContent.js", "commonRecordings.js", "dashboardCalendarNew.js"]}],type:"JSP",pageReqType:"IN"},
        ...
        "user-screening-profiles":{url:"",file:[{role:"",fileName:["userApplicationContent.js","userApplication.js", "manageTeacherProfileContent.js", "manageTeacherProfile.js", "teacherScreeningProfileContent.js", "teacherScreeningProfile.js","jquery.ckeditor.js","cropperImageChatSupportDocument.js","finalRoundOfInterviewSlotsContent.js", "finalRoundOfInterviewSlots.js"]},{role:"js",fileName:["ckeditor.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
        ...
        // STUDENT PAGE CONFIG
        "batch-schedule":{url:"teacher-batch-time-schedule?moduleId="+moduleId+"&userId="+extraParam,file:[{role:"",fileName:["dashboardSchoolBatches.js"]},{role:"js",fileName:["timepicker.js"]}],funName:function(){},type:"JSP",pageReqType:"IN"},
        ...
        "student-council-club":{url:"student-council-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-debate-club":{url:"the-debate-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-book-club":{url:"the-book-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-art-club":{url:"the-art-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-stem-club":{url:"the-stem-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-gaming-club":{url:"the-gaming-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-law-club":{url:"the-law-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-global-exchange-club":{url:"the-global-exchange-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-wellness-club":{url:"the-wellness-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-newsletter-club":{url:"the-newsletter-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        "the-entrepreneurship-club":{url:"the-entrepreneurship-club",file:[{role:"",fileName:["clubsCommonContent.js","clubsCommon.js"]}],funName:function(){},init: function(){},type:"JS",pageReqType:"IN"},
        // PARENT //
        ...
        "counselor-dashboard":{url:"",file:[{role:"",fileName:["CounselorDashboardContent.js","leadCalenderDashboard.js"]}],funName:function(){},type:"JS",pageReqType:"IN"},
