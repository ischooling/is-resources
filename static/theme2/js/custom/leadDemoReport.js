...
function initLeadDemoReportFilters() {
    var today = new Date();
    $('#leadDemoReportCounselorId').html('<option value="">All Academic Expert</option>');
...
function downloadLeadDemoReportCsv(rows) {
    var header = ['Academic Expert', 'Total Demo', 'Demo Done', 'Demo Not Done', 'No Status Update', 'Status Updated', 'Host Not Join', 'Attendee Not Join', 'Attendee Before Click', 'Host Wait Avg', 'Response Avg', 'User Wise Demo Done', 'Cancelled', 'Not Show', 'Demo Not Confirm', 'Reschedule'];
    var csv = [header.join(',')];
...
function downloadLeadDemoReportExcel(rows) {
    var html = '<table border="1"><tr>'
        + '<th>Academic Expert</th><th>Total Demo</th><th>Demo Done</th><th>Demo Not Done</th><th>No Status Update</th>'
