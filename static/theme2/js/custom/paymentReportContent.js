		...
		+'<div class="main-card mb-3">'
			+'<div class="full">'
				...
				+'<div class="d-flex border-bottom full pb-2 border-primary">'
					...
					+'</div>'
					+'<button class=" btn btn-primary  text-white  btn-full-mobile mr-2" onclick="getWatiBroadcastTemplates(\'WATI\')">Wati Broadcast</button>'
			...
			+'<div class="card-body">'
				+'<form id="studentPaymentForm" class="custom-field-scope">'
					+'<div class="row">'
						...
						+'<div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">'
							+'<div class="form-group custom-field">'
								+'<select id="countryId" class="form-control selectReset multiple-select-option" multiple="multiple">'
								+'</select>'
								+'<label>Country</label>'
							+'</div>'
						+'</div>'
...
function successFailedWatiMessagesModal(allData) {
	...
	var isGupshupResult = (typeof STUDENT_BROADCAST_PROVIDER !== 'undefined')
		&& STUDENT_BROADCAST_PROVIDER === 'GUPSHUP';
